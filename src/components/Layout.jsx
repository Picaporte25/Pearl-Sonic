...
export default function Layout({ children, title = 'Pearl-Sonic', user = null, credits = 0 }) {
  ...
  */
  ...
  return (
    <>
      <Head>
        <title>{title}</title>
        <meta name="description" content="Create music with artificial intelligence - Pearl-Sonic" />
